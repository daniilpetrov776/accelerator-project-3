...
const formInputs = form.querySelectorAll('.data-form__input');
const nameInput = form.querySelector('.data-form__input--name');
const phoneInput = form.querySelector('.data-form__input--phone');
const commentInput = form.querySelector('.data-form__input--comment');
const fakeSelect = form.querySelector('.data-form__select');
const select = form.querySelector('.data-form__input--select');
const selectOptions = form.querySelectorAll('.select__option');
const checkboxInput = form.querySelector('.data-form__input--check');
...
const onFormSubmit = (evt) => {
  ...
  if (!checkboxInput.checked) {
    ...
    checkboxInput.classList.remove('data-form__input--error');
  }
